...
var number2 = 6;
 ...
 console.log( showOperationMessage(operationSignal, number1, number2), number1 + number2 );
...
var subtraction = calculator (subop);
var mult = calculator (multop);
var divis = calculator (divop);
var mod = calculator (modop);

console.log( subtraction( number1, number2 ) );
console.log( mult( number1, number2 ) );
console.log( divis( number1, number2 ) );
